import React, { useEffect, useRef, useState, ustEffect } from "react";
    ...
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      <div className="mt-8">
        <button
          ...
          className="transition duration-200 ease hover:bg-indigo-500 inline-block bg-indigo-300 text-lg rounded-full text-white px-8 py-3 cursor-pointer"
        >
          Post Comments
        </button>
        {showSuccessMessage && (
